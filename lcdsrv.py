...
def usage():
    print 'Usage: lcdui.py --init --debug --backlightoff --text "Hello world!" --line 1'
"""
...
def main():    
    ...
    try:
        opts, args = getopt.getopt(sys.argv[1:],"cidbt:l:",["clear", "init","debug","backlightoff","text=","line="])
